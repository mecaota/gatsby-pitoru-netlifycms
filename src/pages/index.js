...
class Hero extends React.Component {
  ...
  up_imageindex = () => {
    this.set_imageindex(this.state.image_index + 1);
  };
  down_imageindex = () => {
    this.set_imageindex(this.state.image_index - 1);
  };
  set_imageindex = index => {
    return new Promise(resolve => {
      ...
      .then(() => {
        setTimeout(() => {
          this.setState({ heroimage: 'background-cover fadein' });
        }, 500);
      });
  };
  changeImage = index => {
  ...
  render() {
    return (
      <div>
        <img
          className={this.state.heroimage}
        ...
        <section className="section hero is-fullheight is-fixed">
          ...
          <div className="hero-foot">
            <div className="container has-text-centered .blur">
              ...
              >
                <button
                  className="pagination-previous is-size-4"
                  onClick={this.down_imageindex.bind(this)}
                >
                  ←
                </button>
                <button
                  className="pagination-next is-size-4"
                  onClick={this.up_imageindex.bind()}
                >
                  →
                </button>
                  ...
                  {this.state.images.map((image, index) => (
                    <li>
                      <button
                        ...
                        aria-label={'画像' + index}
                        onClick={this.set_imageindex.bind(this, index)}
                      >
                        {index}
                      </button>
                    </li>
  ...
  render() {
    ...
    const images = [
      !!data.image1.childImageSharp
        ? data.image1.childImageSharp.fluid.src
        : data.image1,
      !!data.image2.childImageSharp
        ? data.image2.childImageSharp.fluid.src
        : data.image2,
    ];
      ...
      <Layout menu="home">
        ...
        <footer className="footer whiteback">
          <div className="content has-text-centered">
            <p>
              Made by <a href="https://pito.run">pitoru</a>.{' '}
            </p>
            <p>
